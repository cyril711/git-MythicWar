...
#
# Created: Tue Dec 23 22:48:48 2014
...
class Ui_DialogKingdomImport(object):
    def setupUi(self, DialogKingdomImport):
        ...
        self.factionComboBox.setEditable(True)
        self.factionComboBox.setObjectName("factionComboBox")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.factionComboBox)
        ...
        self.empireComboBox.setEditable(True)
        self.empireComboBox.setObjectName("empireComboBox")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.empireComboBox)
        ...
        self.kingdomComboBox.setEditable(True)
        self.kingdomComboBox.setObjectName("kingdomComboBox")
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.kingdomComboBox)
