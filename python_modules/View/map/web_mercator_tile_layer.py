...
from python_modules.View.map import layer
from python_modules.View.map import web_mercator_tile_worker
from python_modules.View.map import layer_config_file_manager
from python_modules.utils import projection
from python_modules.View.map import tile
from python_modules.config import Config
from python_modules.View.map import layer_adapter
from PyQt5.Qt import QMenu, QAction, QRectF, QCursor
