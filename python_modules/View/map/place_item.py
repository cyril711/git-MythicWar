...
from PyQt5.Qt import QColor, QRectF, QPen, QBrush, pyqtSignal, QPolygonF,\
    QAction, QMenu, QPainterPath, QPointF, QLinearGradient, QVBoxLayout,\
    QGraphicsEllipseItem, QGraphicsItem
from PyQt5 import QtGui, QtCore
from python_modules.View.map import shapes
from python_modules.View.temple_view import TempleView
