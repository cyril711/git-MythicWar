from PyQt5.Qt import QWidget, QVBoxLayout, QLabel, QPlainTextEdit, QGridLayout,\
    QPushButton, QPixmap, QIcon, QSize, qWarning, QSizePolicy, QFont
from PyQt5 import QtCore
from python_modules.View.ui_book_world_army import Ui_BookWorldArmy
