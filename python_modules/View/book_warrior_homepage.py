from PyQt5.Qt import QTextEdit, QLayout, QPushButton, QLabel, QVBoxLayout,\
    ...
    QXmlStreamReader, QSizePolicy, QIcon, QTreeWidgetItem
from PyQt5 import QtCore, QtWidgets
     
from python_modules.View.ui_book_warrior_homepage import Ui_BookWarriorHomepage
...
#         warrior_label.setAlignment(QtCore.Qt.AlignCenter)
        ...
        icon = QIcon(QPixmap(basepath+"/"+faction_name+"/"+empire_name+"/"+kingdom_name+"/Picture/"+groupe_name+"/"+warrior.name+"/portrait_thumbnail.jpg"))
