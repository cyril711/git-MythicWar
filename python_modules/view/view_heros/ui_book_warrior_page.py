...
class Ui_BookWarriorPage(object):
    def setupUi(self, BookWarriorPage):
        ...
        BookWarriorPage.resize(929, 660)
        ...
        self.belong_master_widget = QtWidgets.QWidget(self.infos_widget)
        self.belong_master_widget.setObjectName("belong_master_widget")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.belong_master_widget)
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.belong_widget = QtWidgets.QWidget(self.belong_master_widget)
        ...
        self.belong_layout.setContentsMargins(9, 0, 9, -1)
        ...
        sizePolicy.setHeightForWidth(self.profil_completion_button.sizePolicy().hasHeightForWidth())
        self.profil_completion_button.setSizePolicy(sizePolicy)
        self.profil_completion_button.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/24x24/home"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.profil_completion_button.setIcon(icon3)
        self.profil_completion_button.setIconSize(QtCore.QSize(30, 30))
        self.profil_completion_button.setCheckable(False)
        self.profil_completion_button.setFlat(True)
        ...
        self.verticalLayout_2.addWidget(self.belong_widget)
        self.groupe_texture_button = QtWidgets.QPushButton(self.belong_master_widget)
        ...
        self.verticalLayout_2.addWidget(self.groupe_texture_button)
        self.verticalLayout_3.addWidget(self.belong_master_widget)
        self.rank_widget_master = QtWidgets.QWidget(self.infos_widget)
        self.rank_widget_master.setObjectName("rank_widget_master")
        self.rank_widget_layout = QtWidgets.QHBoxLayout(self.rank_widget_master)
        self.rank_widget_layout.setContentsMargins(0, 0, 0, 0)
        self.rank_widget_layout.setObjectName("rank_widget_layout")
        self.big_star = QtWidgets.QPushButton(self.rank_widget_master)
        self.big_star.setText("")
        self.big_star.setIconSize(QtCore.QSize(64, 64))
        self.big_star.setFlat(True)
        self.big_star.setObjectName("big_star")
        self.rank_widget_layout.addWidget(self.big_star)
        self.star_1 = QtWidgets.QPushButton(self.rank_widget_master)
        self.star_1.setText("")
        self.star_1.setFlat(True)
        self.star_1.setObjectName("star_1")
        self.rank_widget_layout.addWidget(self.star_1)
        self.star_2 = QtWidgets.QPushButton(self.rank_widget_master)
        self.star_2.setText("")
        self.star_2.setObjectName("star_2")
        self.rank_widget_layout.addWidget(self.star_2)
        self.star_3 = QtWidgets.QPushButton(self.rank_widget_master)
        self.star_3.setText("")
        self.star_3.setObjectName("star_3")
        self.rank_widget_layout.addWidget(self.star_3)
        self.star_4 = QtWidgets.QPushButton(self.rank_widget_master)
        self.star_4.setText("")
        self.star_4.setObjectName("star_4")
        self.rank_widget_layout.addWidget(self.star_4)
        self.star_5 = QtWidgets.QPushButton(self.rank_widget_master)
        self.star_5.setText("")
        self.star_5.setObjectName("star_5")
        self.rank_widget_layout.addWidget(self.star_5)
        self.rank_text = QtWidgets.QLabel(self.rank_widget_master)
        font = QtGui.QFont()
        font.setPointSize(30)
        font.setKerning(True)
        self.rank_text.setFont(font)
        self.rank_text.setScaledContents(False)
        self.rank_text.setAlignment(QtCore.Qt.AlignCenter)
        self.rank_text.setWordWrap(False)
        self.rank_text.setObjectName("rank_text")
        self.rank_widget_layout.addWidget(self.rank_text)
        self.verticalLayout_3.addWidget(self.rank_widget_master)
        ...
        self.groupBox = QtWidgets.QGroupBox(self.jauges_widget)
...
"")
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.progressBar_HP)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.progressBar_MP)
        ...
        self.current_state_label = QtWidgets.QLabel(self.groupBox)
        self.current_state_label.setObjectName("current_state_label")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.current_state_label)
        self.verticalLayout_4.addWidget(self.groupBox)
        self.widget_2 = QtWidgets.QWidget(self.jauges_widget)
        self.widget_2.setObjectName("widget_2")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout(self.widget_2)
        self.horizontalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.map_button = QtWidgets.QPushButton(self.widget_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/128x128/target"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.map_button.setIcon(icon4)
        self.map_button.setIconSize(QtCore.QSize(64, 64))
        self.map_button.setFlat(True)
        self.map_button.setObjectName("map_button")
        self.horizontalLayout_4.addWidget(self.map_button)
        self.iconState = QtWidgets.QLabel(self.widget_2)
        self.iconState.setObjectName("iconState")
        self.horizontalLayout_4.addWidget(self.iconState)
        ...
        self.gallery.setGeometry(QtCore.QRect(0, 0, 280, 401))
    ...
    def retranslateUi(self, BookWarriorPage):
        ...
        self.profil_completion_button.setToolTip(_translate("BookWarriorPage", "Profile complet"))
        self.rank_text.setText(_translate("BookWarriorPage", "1"))
        self.groupBox.setTitle(_translate("BookWarriorPage", "State"))
        self.label.setText(_translate("BookWarriorPage", "Santé"))
        self.label_2.setText(_translate("BookWarriorPage", "Vitalité"))
        self.current_state_label.setText(_translate("BookWarriorPage", "TextLabel"))
        self.iconState.setText(_translate("BookWarriorPage", "iconState"))
        ...
        self.label_12.setText(_translate("BookWarriorPage", "END"))
