...
class Ui_BookWarriorPage(object):
    def setupUi(self, BookWarriorPage):
        ...
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout(self.rank_widget_master)
        ...
        self.horizontalLayout_5.addWidget(self.rank_text)
