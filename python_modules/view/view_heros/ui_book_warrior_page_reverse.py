...
#
# Created: Sat Feb 14 22:22:01 2015
...
class Ui_BookWarriorPageReverse(object):
    def setupUi(self, BookWarriorPageReverse):
        ...
        BookWarriorPageReverse.resize(929, 620)
...
"")
        ...
        self.groupBox = QtWidgets.QGroupBox(self.informations_widget)
        ...
        self.horizontalLayout_4.addWidget(self.rank_widget)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/24x24/home"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.vignettes.setGeometry(QtCore.QRect(0, 0, 260, 98))
    ...
    def retranslateUi(self, BookWarriorPageReverse):
        ...
        self.groupBox.setTitle(_translate("BookWarriorPageReverse", "Informations"))
        self.label.setText(_translate("BookWarriorPageReverse", "Faction"))
        self.label_2.setText(_translate("BookWarriorPageReverse", "Empire"))
        self.label_faction.setText(_translate("BookWarriorPageReverse", "TextLabel"))
        self.label_empire.setText(_translate("BookWarriorPageReverse", "TextLabel"))
        self.label_17.setText(_translate("BookWarriorPageReverse", "Kingdom"))
        self.label_royaume.setText(_translate("BookWarriorPageReverse", "TextLabel"))
        ...
        self.label_12.setText(_translate("BookWarriorPageReverse", "MP"))
